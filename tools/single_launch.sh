...
main() {
  ...
  local cmd_rviz="${env_setup}; ${wait_lib}; wait_for_master; wait_for_topic /mock_map; wait_for_topic /depth_image; wait_for_topic /yopo_net/trajs_visual; cd /workspace/YOPO/YOPO; rviz -d single_yopo.rviz"
