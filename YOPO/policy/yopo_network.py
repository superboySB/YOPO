...
class YopoNetwork(nn.Module):
    ...
    def __init__(
        ...
        observation_dim = cfg["observation_dim"] if observation_dim is None else observation_dim
        output_dim = cfg["output_dim"] if output_dim is None else output_dim
        input_channels = cfg["input_channels"] if input_channels is None else input_channels
